...
HEAVYWEIGHT_RATIO = 0.7         # если 70%+ свечей в широком окне "горячие" — это норма монеты
...
ALERT_COOLDOWN_SEC = 30 * 60    # не слать повторный алерт по той же монете чаще раза в 30 минут
...
def run_cycle() -> None:
    ...
    candidates = [c for c in coins.values() if c["volume"] >= MIN_24H_VOLUME_USD]
